 ...
 * Value explanation:   ASR 保存音频文件开关
 * Value type:          bool
 * Default value:       false
 */
 ...
 * Value explanation:   ASR 保存音频文件路径
 * Value type:          string
...
/*================================ VAD-MFE ===============================*/
    ...
    */
     ...
     * Value type:          float (该值为帧数，每帧大小为10ms)
     * Default value:       -
     */
...
/*================================ SERVER ===============================*/
     ...
     * Value explanation:   设置SECRET_KEY
     * Value type:          std::string
     * Default value:       -
     */
